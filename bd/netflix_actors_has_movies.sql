...
CREATE TABLE `actors_has_movies` (
  ...
  PRIMARY KEY (`actors_idactors`,`movies_idmovies`),
  KEY `fk_actors_has_movies_movies1_idx` (`movies_idmovies`),
  KEY `fk_actors_has_movies_actors_idx` (`actors_idactors`),
  CONSTRAINT `fk_actors_has_movies_actors` FOREIGN KEY (`actors_idactors`) REFERENCES `actors` (`idactors`),
...
-- Dump completed on 2025-07-15 21:35:17
